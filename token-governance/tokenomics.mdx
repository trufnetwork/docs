...
The TRUF token serves as the economic layer for TRUF.NETWORK's products and ecosystem, including the TRUF.NETWORK (TN). At launch, the total supply of TRUF tokens is capped at one billion (1,000,000,000), allocated as follows:
