...
> **Note**: While this guide uses Python for examples, adapters can also be written in other languages like Go or JavaScript. Refer to the respective SDKs for more information:
