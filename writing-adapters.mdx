...
description: A comprehensive guide to creating adapters for the Truf Network (TN) using the SDK and Prefect.
---

# Developing Adapters for the Truflation Stream Network
