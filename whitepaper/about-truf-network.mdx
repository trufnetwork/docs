...
At the core of TRUF.NETWORK is the TRUF token, a cross-chain asset available on both the Ethereum and Solana blockchains. On Ethereum, it follows the ERC-20 standard, while on Solana it adheres to the SPL token standard. The TRUF token serves multiple functions:
