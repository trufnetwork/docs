...
TRUF is a cross-chain token that adheres to the ERC-20 and SPL token standards and serves as the economic layer of the TRUF.NETWORK ecosystem. Its main functions include:
- Data provision and consumption
- Node operation
- Governance
