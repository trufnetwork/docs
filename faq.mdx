...
## Our FAQ aims to answer every question we've been asked on TRUF.NETWORK and TRUF
...
TRUF is a cross-chain token that adheres to the ERC-20 and SPL token standards that serves as the economic layer for the TRUF.NETWORK ecosystem. Its main functions are Data Provider, Node Operation, Data Provision and Consumption, and Governance.

### How can users participate in TRUF.NETWORK governance?
...
Users can bridge TRUF tokens through TRUF.NETWORK's user interface, which uses Chainlink's Cross-Chain Interoperability Protocol (CCIP) to transfer tokens between Ethereum, Arbitrum, Base, and Solana networks.

### On which exchanges is TRUF available?

TRUF is available on centralized exchanges like KuCoin, Bitstamp, MEXC, and Gate.io, as well as decentralized exchanges like Uniswap, Aerodrome, and Raydium.
...
### Has the TRUF.NETWORK smart contract been audited?

Yes, Stronghold has successfully fully audited TRUF.NETWORK's governance and staking contracts.
