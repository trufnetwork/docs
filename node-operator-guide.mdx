...
For detailed instructions on configuration options more relevant to a production setup, refer to our [TRUF.NETWORK Node Operator Guide](https://github.com/trufnetwork/truf-node-operator).
